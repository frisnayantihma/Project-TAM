...
import com.example.project531.Activity.DetailActivity;
...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ArrayList<CoffeDomain> RecommendedDomains;

    public RecommendedAdapter(ArrayList<CoffeDomain> RecommendedDomains) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_recommended, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.fee.setText(String.valueOf(RecommendedDomains.get(position).getBayar()));
