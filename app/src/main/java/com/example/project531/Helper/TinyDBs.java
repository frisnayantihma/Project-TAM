...
public class TinyDBs {
    ...
    public TinyDBs(Context appContext) {
    ...
    public ArrayList<CoffeDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CoffeDomain> playerList =  new ArrayList<CoffeDomain>();

        for(String jObjString : objStrings){
            CoffeDomain player  = gson.fromJson(jObjString,  CoffeDomain.class);
    ...
    public void putListObject(String key, ArrayList<CoffeDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CoffeDomain player: playerList){
